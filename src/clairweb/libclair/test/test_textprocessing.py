...
#     
#     fr = make_data_frame(econdata.models.Listing, 3)
...
def test_HtmlTool_remove_html():
    ...
    assert HtmlTool.remove_html(np.nan) == ""
...
def test_HtmlTool_to_nice_text():
    ...
    assert text_nice.find("Blitzgerät") != -1
    assert text_nice.find("Rückseite") != -1
    assert len(text_nice.split("\n")) == 8
    
    
# def test_FeatureExtractor():
#     """Test ``FeatureExtractor`` class."""
#     from libclair.textprocessing import FeatureExtractor
#     from libclair.coredata import DataStore
#     
...
#     feature_words = ["nikon", "photo", "d90", "blitzgerät",
...
#     assert features['contains-blitzgerät'] == True
#     
...
#     """Test ``FeatureExtractor`` class."""
#     from libclair.textprocessing import ProductRecognizer, split_random
#     from libclair.coredata import DataStore
#     print("start")
#     
#     data_dir = relative("../../example-data")
...
#     from libclair.textprocessing import RecognizerController
#     from libclair.coredata import DataStore
#     
#     data_dir = relative("../../example-data")
#     data = DataStore()
...
#     from libclair.textprocessing import split_random
#     
